...
# Private Lib
from Model.GFS_GAT_Regression import GraphFuzzySystem
...
if __name__ == '__main__':
    ...
    DatasetName = HyperParamConfig['DatasetName']
    ...
    logger.add(
        "./results/logs/{}/GFS_EnsembleGAT_Regression_Dataset-{}_TimeStamp-{}.log".format(DatasetName, DatasetName, TimeStr))
    num_folds = 5
            ...
            for lr in Lrs:
                ...
                for HiddenDim in HiddenDims:
                    ...
                    for mini_batch_size in MiniBatchSize:
                        ...
                        pandas.DataFrame([temp_res_list]).to_csv('./results/csv/{}/{}_{}.csv'.format(DatasetName,  file_name, TimeStr),
                                                                 index=False, mode='a')
